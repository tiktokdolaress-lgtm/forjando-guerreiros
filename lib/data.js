...
export const TIERS = [
  { min: 0, slots: 2, name: 'NEÓFITO DA FORJA', icon: '🛡️', reward: 'Túnica de Cinzas & Mãos Enfaixadas', image: '/escudeiro.png', subtitle: 'Iniciado da Forja' },
  { min: 4, slots: 3, name: 'PAJEM DE ARMAS', icon: '🗡️', reward: 'Colete de Couro Cru & Lâmina Rústica', image: '/escudeiro.png', subtitle: 'Despertar do Fogo Vital' },
  { min: 8, slots: 4, name: 'ESCUDEIRO FORJADO', icon: '⚔️', reward: 'Gibão de Couro Batido & Brasas Vivas', image: '/escudeiro.png', subtitle: 'Fim da Névoa Mental' },
  { min: 15, slots: 5, name: 'HOMEM-DE-ARMAS', icon: '🛡️', reward: 'Primeira Cota de Malha & Escudo de Carvalho', image: '/escudeiro.png', subtitle: 'Rebalanceamento Dopaminérgico' },
  { min: 31, slots: 6, name: 'CAVALEIRO DA ORDEM', icon: '🏛️', reward: 'Peitoral de Placas de Aço & Manto', image: '/escudeiro.png', subtitle: 'Autodomínio Inabalável' },
  { min: 61, slots: 7, name: 'CAMPEÃO DA FORJA', icon: '🐉', reward: 'Armadura Gótica & Bigorna Incandescente', image: '/escudeiro.png', subtitle: 'Fim da Flatline · Vitória dos 90 Dias' },
  { min: 120, slots: 99, name: 'LORDE COMANDANTE', icon: '🔥', reward: 'Aço Escuro, Bronze & Espada Dupla', image: '/escudeiro.png', subtitle: 'Blindagem Contra Recaídas (4 Meses)' },
  { min: 180, slots: 99, name: 'GRÃO-MESTRE DA ORDEM', icon: '⚡', reward: 'Armadura de Aço Damasco & Fogo Eterno', image: '/escudeiro.png', subtitle: 'Reconfiguração Neural (6 Meses)' },
  { min: 270, slots: 99, name: 'SOBERANO DO TEMPLO', icon: '🦅', reward: 'Placas Negras com Runas Douradas', image: '/escudeiro.png', subtitle: 'Transmutação Máxima (9 Meses)' },
  { min: 365, slots: 99, name: 'PATRIARCA IMORTAL', icon: '👑', reward: 'Armadura Real Dourada & Manto Sagrado', image: '/escudeiro.png', subtitle: 'Soberania Eterna · 1 Ano Completo' },
  { min: 730, slots: 99, name: 'SOBERANO ANCESTRAL', icon: '☀️', reward: 'Panteão dos Reis Imortais (2 Anos)', image: '/escudeiro.png', subtitle: 'Mito Vivo Inconcussável' },
];
...
export const METAS = [
  { d: 3, icon: '🛡️', n: 'NEÓFITO DA FORJA', sub: 'Quebra do Ciclo Automático' },
  { d: 7, icon: '🗡️', n: 'PAJEM DE ARMAS', sub: 'Pico Natural de Testosterona (+45%)' },
  { d: 14, icon: '⚔️', n: 'ESCUDEIRO FORJADO', sub: 'Estabilização Inicial & Fim da Névoa' },
  { d: 30, icon: '🛡️', n: 'HOMEM-DE-ARMAS', sub: 'Cota de Malha & Rebalanceamento de Dopamina' },
  { d: 60, icon: '🏛️', n: 'CAVALEIRO DA ORDEM', sub: 'Placas de Aço & Controle de Pensamentos' },
  { d: 90, icon: '🐉', n: 'CAMPEÃO DA FORJA', sub: 'Reset Completo · O Grande Marco dos 90 Dias' },
  { d: 120, icon: '🔥', n: 'LORDE COMANDANTE', sub: 'Blindagem Contra Recaídas Tardias (4 Meses)' },
  { d: 180, icon: '⚡', n: 'GRÃO-MESTRE DA ORDEM', sub: 'Aço Damasco · Meio Ano Limpo (6 Meses)' },
  { d: 270, icon: '🦅', n: 'SOBERANO DO TEMPLO', sub: 'Transmutação em Conquistas Reais (9 Meses)' },
  { d: 365, icon: '👑', n: 'PATRIARCA IMORTAL', sub: 'Soberania Eterna · 1 Ano Completo de Glória' },
];
