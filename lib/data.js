...
export const TIERS = [
  { min: 0, slots: 2, name: 'ESCUDEIRO', icon: '🛡️', reward: '', image: '/escudeiro.png', subtitle: 'Iniciado da Forja' },
  { min: 7, slots: 4, name: 'HOMEM-DE-ARMAS', icon: '⚔️', reward: 'Lâmina de Ferro Forjado', image: '/escudeiro.png', subtitle: 'Combatente da Forja' },
  { min: 15, slots: 5, name: 'VANGUARDEIRO', icon: '🛡️', reward: 'Escudo Heraldico', image: '/escudeiro.png', subtitle: 'Linha de Frente' },
  { min: 30, slots: 6, name: 'GUARDIÃO DA ORDEM', icon: '🏛️', reward: 'Peitoral de Aço Temperado', image: '/escudeiro.png', subtitle: 'Veterano Inabalável' },
  { min: 60, slots: 7, name: 'PALADINO DE AÇO', icon: '🗡️', reward: 'Elmo de Guerra Fechado', image: '/escudeiro.png', subtitle: 'Mestre da Disciplina' },
  { min: 90, slots: 99, name: 'GRÃO-MESTRE DA FORJA', icon: '🐉', reward: 'Elmo Espartano Dourado & Aura Solar', image: '/escudeiro.png', subtitle: 'Soberano da Vontade' },
  { min: 150, slots: 99, name: 'SENHOR DA GUERRA', icon: '🔥', reward: 'Armadura de Obsidiana & Fogo', image: '/escudeiro.png', subtitle: 'Comandante Supremo' },
  { min: 270, slots: 99, name: 'CAMPEÃO IMORTAL', icon: '⚡', reward: 'Lâmina de Dragão Incandescente', image: '/escudeiro.png', subtitle: 'Espírito Indestrutível' },
  { min: 365, slots: 99, name: 'LORDE DA FORJA IMPERIAL', icon: '👑', reward: 'Manto Sagrado de Ouro Maciço', image: '/escudeiro.png', subtitle: 'Transmutação Lendária (1 Ano)' },
  { min: 730, slots: 99, name: 'SOBERANO ANCESTRAL', icon: '🦅', reward: 'Panteão dos Reis Imortais (2 Anos)', image: '/escudeiro.png', subtitle: 'Mito Vivo Inconcussável' },
];
...
export const METAS = [
  { d: 7, icon: '🛡️', n: 'ESCUDEIRO', sub: 'Prova de Fogo do Protocolo · Teste Gratuito' },
  { d: 14, icon: '⚔️', n: 'HOMEM-DE-ARMAS', sub: 'Estabilização Inicial & Primeira Lâmina' },
  { d: 21, icon: '🛡️', n: 'VANGUARDEIRO', sub: 'Desintoxicação e Consolidação do Hábito' },
  { d: 45, icon: '🏛️', n: 'GUARDIÃO DA ORDEM', sub: 'Reorganização Dopaminérgica Profunda' },
  { d: 90, icon: '🐉', n: 'GRÃO-MESTRE DA FORJA', sub: 'Reset Neuroquímico Completo & Elmo Dourado' },
  { d: 150, icon: '🔥', n: 'SENHOR DA GUERRA', sub: 'Soberania Absoluta da Energia Vital' },
  { d: 365, icon: '👑', n: 'LORDE DA FORJA IMPERIAL', sub: 'Transmutação Completa de 1 Ano' },
];
