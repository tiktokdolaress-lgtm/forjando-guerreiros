...
export const CONTENT = {
  ...
  metas: {
    7: { en: { n: 'SQUIRE', sub: 'Protocol Trial by Fire · Free Trial' }, es: { n: 'ESCUDERO', sub: 'Prueba de Fuego del Protocolo · Prueba Gratuita' } },
    14: { en: { n: 'MAN-AT-ARMS', sub: 'Initial Stabilization & First Blade' }, es: { n: 'HOMBRE DE ARMAS', sub: 'Estabilización Inicial y Primera Hoja' } },
    21: { en: { n: 'VANGUARD', sub: 'Detox and Habit Consolidation' }, es: { n: 'VANGUARDIERO', sub: 'Desintoxicación y Consolidación del Hábito' } },
    45: { en: { n: 'ORDER GUARDIAN', sub: 'Deep Dopaminergic Reorganization' }, es: { n: 'GUARDIÁN DE LA ORDEN', sub: 'Reorganización Dopaminérgica Profunda' } },
    90: { en: { n: 'GRANDMASTER OF THE FORGE', sub: 'Complete Neurochemical Reset & Golden Helmet' }, es: { n: 'GRAN MAESTRO DE LA FORJA', sub: 'Reinicio Neuroquímico Completo y Casco Dorado' } },
    150: { en: { n: 'WARLORD', sub: 'Absolute Sovereignty of Vital Energy' }, es: { n: 'SEÑOR DE LA GUERRA', sub: 'Soberanía Absoluta de la Energía Vital' } },
    365: { en: { n: 'IMPERIAL FORGE LORD', sub: '1-Year Complete Legendary Transmutation' }, es: { n: 'SEÑOR DE LA FORJA IMPERIAL', sub: 'Transmutación Legendaria Completa de 1 Año' } },
  },
  life: {
  ...
  tiers: {
    en: {
      ...
      2: { name: 'CENTURION' },
      3: { name: 'SPARTAN' },
      4: { name: 'MONK / LORD OF THE FORGE', reward: 'Golden Aura in HQ' },
      5: { name: 'ASTRAL TRANSMUTER', reward: 'Cosmic Onyx Theme + exclusive sound synthesis' },
      6: { name: 'UNSHAKABLE LEGEND', reward: 'Titanium Insignia + Legend status' }
    },
    es: {
      0: { name: 'RECLUTA' },
      1: { name: 'GUERRERO' },
      2: { name: 'CENTURIÓN' },
      3: { name: 'ESPARTANO' },
      4: { name: 'MONJE / SEÑOR DE LA FORJA', reward: 'Aura Dorada en el QG' },
      5: { name: 'TRANSMUTADOR ASTRAL', reward: 'Tema Ónix Cósmico + síntesis sonora exclusiva' },
      6: { name: 'LEYENDA INQUEBRANTABLE', reward: 'Insignia de Titanio + estatus Leyenda' }
    }
  },
