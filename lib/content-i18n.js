...
export const CONTENT = {
  ...
  stats: {
    ...
    tl_custom_btn: { pt: 'Personalizado 📅', en: 'Custom 📅', es: 'Personalizado 📅' },
    tl_custom_start: { pt: 'Início', en: 'Start', es: 'Inicio' },
    tl_custom_end: { pt: 'Fim', en: 'End', es: 'Fin' },
    tl_custom_filter: { pt: 'Período Personalizado', en: 'Custom Range', es: 'Período Personalizado' },
    curve_title: { pt: 'CURVA DE VITALIDADE & FORÇA', en: 'VITALITY & STRENGTH CURVE', es: 'CURVA DE VITALIDAD Y FUERZA' },
    curve_sub: { pt: 'Sincronizada aos 3 Pilares da Tríade: sobe com dias limpos e reage proporcionalmente a cada pilar.', en: 'Synced with the 3 Pillars: climbs with clean days and drops proportionally to pillar slips.', es: 'Sincronizada con los 3 Pilares: sube con días limpios y baja proporcionalmente a los deslices.' },
    curve_cur: { pt: 'Vitalidade Atual: ', en: 'Current Vitality: ', es: 'Vitalidad Actual: ' },
    curve_peak_label: { pt: 'Pico no Período: ', en: 'Period Peak: ', es: 'Pico en el Período: ' },
    curve_avg_label: { pt: 'Média: ', en: 'Average: ', es: 'Promedio: ' },
    curve_p1_name: { pt: 'Zero Pornografia', en: 'Zero Pornography', es: 'Cero Pornografía' },
    curve_p2_name: { pt: 'Autodomínio Inabalável', en: 'Unshakable Self-Control', es: 'Autodominio Inquebrantable' },
    curve_p3_name: { pt: 'Retenção Seminal', en: 'Semen Retention', es: 'Retención Seminal' },
    curve_pillar_ok: { pt: 'Preservado', en: 'Preserved', es: 'Preservado' },
    curve_pillar_fail: { pt: 'Queda', en: 'Fell', es: 'Caída' },
    curve_status_win: { pt: 'Vitória Total (+10 pts)', en: 'Full Victory (+10 pts)', es: 'Victoria Total (+10 pts)' },
    curve_status_fall1: { pt: 'Deslize em 1 Pilar (-28%)', en: '1-Pillar Slip (-28%)', es: 'Desliz en 1 Pilar (-28%)' },
    curve_status_fall2: { pt: 'Deslize em 2 Pilares (-65%)', en: '2-Pillar Slip (-65%)', es: 'Desliz en 2 Pilares (-65%)' },
    curve_status_fall3: { pt: 'Queda Total nos 3 Pilares (Fundo: 0%)', en: 'Total Fall in 3 Pillars (Floor: 0%)', es: 'Caída Total en los 3 Pilares (Fondo: 0%)' },
    curve_status_none: { pt: 'Sem registro (-3 pts)', en: 'No log (-3 pts)', es: 'Sin registro (-3 pts)' },
    curve_click_edit: { pt: 'Toque para editar o registro deste dia', en: 'Tap to edit this day\'s log', es: 'Toca para editar el registro de este día' },
  ...
  settings: {
    ...
    fb_badge_admin: { pt: 'COMANDO · CANAL DIRETO', en: 'COMMAND · DIRECT CHANNEL', es: 'COMANDO · CANAL DIRECTO' },
    ...
    notif_off: { en: 'Disable on this device', es: 'Desactivar en este dispositivo' },
    notif_daily_t: { en: 'Nightly check-in reminder (~8 PM)', es: 'Recordatorio nocturno (~20h)' },
    notif_hab_t: { en: 'Habit scheduled times', es: 'Horarios de los hábitos' },
    notif_tasks_t: { en: 'Tasks & Operations', es: 'Tareas y Operaciones' },
    notif_tasks_d: { en: 'Alert at the scheduled time of each task', es: 'Alerta a la hora programada de cada tarea' },
    notif_proj_t: { en: 'Strategic Projects', es: 'Proyectos Estratégicos' },
    notif_proj_d: { en: 'Daily focus window and deadline alerts', es: 'Alertas de ventana de enfoque y fecha límite' },
    notif_sound_t: { en: 'In-app tactical sound', es: 'Sonido táctico interno' },
    notif_sound_d: { en: 'Heroic chime and visual alert when scheduled time triggers', es: 'Acorde heroico y alerta visual al activarse la hora' },
    notif_dual_title: { en: 'Dual Alert Engine (Inside & Outside)', es: 'Motor de Alerta Doble (Dentro y Fuera)' },
    notif_dual_body: {
      en: 'Outside: System notifications on mobile lockscreen and PC at the scheduled minute. Inside: Tactical chimes and in-app banners while navigating.',
      es: 'Fuera: Notificaciones en pantalla de bloqueo de móvil y PC al minuto programado. Dentro: Acorde táctico y banners dentro de la app mientras navegas.',
    },
    notif_test_btn: { en: 'TEST ALERTS (INSIDE & OUTSIDE)', es: 'PROBAR ALERTAS (DENTRO Y FUERA)' },
    notif_test_toast: { en: '⚡ Tactical alert test executed! Both inside and outside alerts active.', es: '⚡ ¡Prueba táctica ejecutada! Alertas interna y externa activas.' },
  ...
  qg: {
    fall_precision_title: { en: '⚔️ REGISTER COMBAT FALL', es: '⚔️ REGISTRAR CAÍDA DE COMBATE' },
    fall_time_lbl: { en: 'Live Fall Timestamp (Honest Reset):', es: 'Registro de Caída en Vivo (Reinicio Honesto):' },
    fall_timer_note: { en: '⏱️ No retroactive edits allowed. The stopwatch resets now and resumes your evolution in real time, second-by-second.', es: '⏱️ Sin alteraciones retroactivas. El cronómetro se reinicia ahora y reanuda tu evolución en tiempo real, segundo a segundo.' },
    fall_toast_ok: { en: '⚠️ Fall logged. The precision stopwatch restarted now — rise up and rebuild!', es: '⚠️ Caída registrada. El cronómetro de precisión se reinició ahora — ¡levántate y reconstruye!' },
  },
};
